...
ComputeStyle(mode,ComputeMode)

#else

#ifndef LMP_COMPUTE_MODE_H
#define LMP_COMPUTE_MODE_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeMode : public Compute {
 public:
  ComputeMode(class LAMMPS *, int, char **);
  ~ComputeMode();
  void init();
  ...
  double pem; // Mode potential energy in the harmonic limit.
 ...
 private:
  ...
  FILE * fh_vm; // Mode velocity file handle.
