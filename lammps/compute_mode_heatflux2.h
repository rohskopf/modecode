...
ComputeStyle(mode/heatflux2,ComputeModeHeatflux2)

#else

#ifndef LMP_COMPUTE_MODE_HEATFLUX2_H
#define LMP_COMPUTE_MODE_HEATFLUX2_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeModeHeatflux2 : public Compute {
 public:
  ComputeModeHeatflux2(class LAMMPS *, int, char **);
  ~ComputeModeHeatflux2();
  void init();
  void compute_vector();
